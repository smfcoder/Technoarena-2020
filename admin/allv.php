              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <thead>
                  <tr>
                   ...
                   <?php
                            include('../db/conn.php');
                            $query="SELECT * From admin where event='publicity';";
                    ...
                    ?>
                                    <tr>  
                                        ...
                                        <td><a class="btn btn-primary" href="ventries.php?id=<?php echo $row['name'];?>">View Entries</a></td>
                                        <td><a class="btn btn-primary" href="editv.php?id=<?php echo $row['id'];?>">edit</a></td>
                                        
                                        <?php
                                            if($row['username']!=$sname)
                                            {
                                        ?>
                                        <td><a class="btn btn-danger" Onclick="return ConfirmDelete()" href="deletev.php?id=<?php echo $row['id'];?>">X</a></td>  
                                        <script>
