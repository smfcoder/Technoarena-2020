...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $content=$_POST['editor1'];
            $ins="UPDATE events SET content='$content' where slug='$slug';";
  ...
  ?>
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <?php
            $q="SELECT * From events where slug='$slug';";
                ...
                <textarea name="editor1"><?php echo $r["content"];?></textarea>
                    <script>
                            CKEDITOR.replace( 'editor1',{
                                                    filebrowserUploadUrl: 'https://technoarena.gcoej.ac.in/editor/ckeditor/ck_upload.php',
