...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $ins='INSERT INTO contact(name,pos,phone) values("'.$disp.'","'.$cpos.'","'.$phone.'");';
    ...
    <div class="table-responsive">
     <table class="table pagin-table" width="100%">
                ...
                <tbody class="row_position">
                   <?php
                            include('../db/conn.php');
                            $query="SELECT * From contact ORDER BY pos;";
                    ...
                    ?>
                                    <tr id="<?php echo $row['id'] ?>">  
                                        ...
                                        <td><a class="btn btn-danger" Onclick="return ConfirmDelete()" href="deletecontact.php?id=<?php echo $row['id'];?>">X</a></td>  
                                   <script>
...
foreach($position as $k=>$v){
    $sq = "Update contact SET pos=".$i." WHERE id=".$v;
