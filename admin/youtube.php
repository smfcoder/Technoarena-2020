...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $link=$_POST['link'];
        $sql_u = "SELECT * FROM youtube where name='$name'";
        ...
        if (mysqli_num_rows($res_u) != 0) {
            ...
            $posi="SELECT * FROM youtube;";
            $qposi_e=mysqli_query($sql,$posi);
            $qposi=mysqli_num_rows($qposi_e);
            $cpos=$qposi+1;
                    
            $ins='INSERT INTO youtube(link,pos) values("'.$link.'","'.$cpos.'");';
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a>ADD Youtubelinks</a>
          </li>
        </ol>
    <form method="POST" action="youtube.php">
        
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Youtube Link</label>
            <div class="col-sm-10">
    ...
    <div class="table-responsive">
     <table class="table pagin-table" width="100%">
                ...
                <tbody class="row_position">
                   <?php
                            include('../db/conn.php');
                            $query="SELECT * From youtube ORDER BY pos;";
                    ...
                    ?>
                                    <tr id="<?php echo $row["id"]; ?>">  
                                        ...
                                        <td><a class="btn btn-danger" Onclick="return ConfirmDelete()" href="deleteyoutube.php?id=<?php echo $row['id'];?>">X</a></td>  
                                   <script>
...
foreach($position as $k=>$v){
    $sq = "Update youtube SET pos=".$i." WHERE id=".$v;
