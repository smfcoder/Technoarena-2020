        ...
        $size = $_FILES['myfile']['size'];
            ...
            else 
            {
                if (move_uploaded_file($file, $destination)) 
                {
                    ...
                    $posi="SELECT * FROM team where pslug='$pslug';";
                    $qposi_e=mysqli_query($sql,$posi);
                    $qposi=mysqli_num_rows($qposi_e);
                    $cpos=$qposi+1;
                    
                    
                    $ins='INSERT INTO team(name,desig,clas,pslug,url,pos) values("'.$name.'","'.$disg.'","'.$clas.'","'.$pslug.'","'.$url.'","'.$cpos.'");';
  ...
  ?>
    ...
    <form method="POST" action="team.php" enctype="multipart/form-data">
        ...
        <div class="form-group row">
         ...
         <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Disg</label>
            <div class="col-sm-10">
              <input type="text" name="disg" class="form-control"  placeholder="disg" >
            </div>
        </div>
                   ...
                   <?php
                    ...
                    ?>
                                    <tr id="<?php echo $row['id'] ?>">  
                                        ...
                                        <td><a class="btn btn-danger" Onclick="return ConfirmDelete()" href="deleteteam.php?id=<?php echo $row['id'];?>">X</a></td>  
                                   <script>
