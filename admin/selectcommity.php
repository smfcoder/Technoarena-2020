...
<?php
    ...
    {
        $slug = $_POST['slug'];
        header('location:/admin/posteam.php?slug='.$slug);
    }
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          <li class="breadcrumb-item">
            <a>Select Committee</a>
          </li>
        </ol>
    <form method="POST" action="selectcommity.php">


        
        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Select Committee</label>
            <div class="col-sm-10">
               <select class="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref" onchange="uniqueUser()" name="slug" required>
                   <option value="">Choose...</option>
                <?php
                        $pq="SELECT * FROM committee";  
