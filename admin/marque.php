...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        {
                $posi="SELECT * FROM parent;";
                $qposi_e=mysqli_query($sql,$posi);
                $qposi=mysqli_num_rows($qposi_e);
                $cpos=$qposi+1;
                $ins="INSERT INTO parent(name,slug,pos) values('$name','$slug','$cpos');";
...
?> 
  ...
  ?>
    ...
    <form method="POST" action="marque.php">


        <div class="form-group row">
            <label for="" class="col-sm-2 col-form-label">Dept Name</label>
            <div class="col-sm-10">
              <input type="text" name="name" class="form-control"  placeholder="Dept Name" required>
            </div>
        </div>
            ...
            <div class="table-responsive">
              <table class="table pagin-table" width="100%" cellspacing="0">
                ...
                <tbody class="row_position">
                   <?php
                            include('../db/conn.php');
                            $query="SELECT * From parent ORDER BY pos;";
...
foreach($position as $k=>$v){
    $sq = "Update parent SET pos=".$i." WHERE id=".$v;
